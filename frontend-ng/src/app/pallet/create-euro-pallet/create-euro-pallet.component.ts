...
@Component({
	...
	imports: [
		MatDialogTitle, MatDialogContent, MatDialogActions, MatButtonModule, MatFormField, MatInput, FormsModule, ReactiveFormsModule, MatSelect, MatOption,
		MatLabel
	],
	...
	private updateValidators(value: LocationTypeDto) {
		...
		switch (value) {
			case LocationTypeDto.AtOperationCenter:
				whichOneGetsIt = ocLoc;
				break;
			case LocationTypeDto.SomewhereElse:
				whichOneGetsIt = somewhereElse;
				break;
			case LocationTypeDto.Logistics:
				whichOneGetsIt = locLoc;
				break;
			default:
