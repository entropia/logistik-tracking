...
export const routes: Routes = [
	{
		path: "", loadComponent: () => import("./homepage/homepage.component")
			.then(it => it.HomepageComponent)
	}, {
		path: 'packingList', loadComponent: () => import("./packlist/packing-list/packing-list.component")
			.then(it => it.PackingListComponent)
	}, {
		path: 'packingList/:id',
		loadComponent: () => import("./packlist/selected-packing-list/selected-packing-list.component")
			.then(it => it.SelectedPackingListComponent)
	}, {
		path: 'packingList/:id/delivery',
		loadComponent: () => import("./packlist/packliste-auslieferung/packliste-auslieferung.component")
			.then(it => it.PacklisteAuslieferungComponent)
	}, {
		path: 'euroCrate',
		loadComponent: () => import("./crate/euro-crate/euro-crate.component").then(it => it.EuroCrateComponent)
	}, {
		...
		path: 'euroPallet',
		loadComponent: () => import("./pallet/euro-pallet/euro-pallet.component").then(it => it.EuroPalletComponent)
	}, {
		path: 'euroPallet/:id',
		loadComponent: () => import("./pallet/selected-euro-pallet/selected-euro-pallet.component")
		...
		path: "users",
		loadComponent: () => import("./users/user-list/user-list.component").then(it => it.UserListComponent)
	}, {
		path: "users/:id",
